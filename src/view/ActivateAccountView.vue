  ...
  <div class="login-page">
    <div class="login-card">
      <div class="login-header">
        ...
        <p>Postavite vašu lozinku za pristup sistemu</p>
      </div>

      <div v-if="alreadyUsed" class="error-banner" role="alert">
        Ovaj aktivacioni link je već iskorišćen. Kontaktirajte administratora.
      </div>

      <div v-else-if="noToken" class="error-banner" role="alert">
        Nevažeći aktivacioni link. Kontaktirajte administratora.
      </div>
      ...
      <form v-else @submit.prevent="handleSubmit" novalidate>
        ...
        <div v-if="success" class="success-banner" role="status">
          Nalog je uspešno aktiviran! Preusmeravamo vas na login...
        </div>
...
async function handleSubmit(): Promise<void> {
  ...
  try {
    await authApi.activate(token.value, form.password, form.passwordConfirm)
    success.value = true
    ...
    if (status === 400) {
      ...
      errors.general = 'Nevažeći aktivacioni token.'
