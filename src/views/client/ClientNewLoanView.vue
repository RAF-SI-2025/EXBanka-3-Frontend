...
const formErrors = computed(() => {
  ...
  const period = Number(form.value.period)
  if (!form.value.period || period < 1 || !Number.isInteger(period)) errs.push('Period mora biti najmanje 1 mesec.')
  ...
  <div class="nl-page">
    ...
    <div class="nl-card">
      ...
      <form v-else @submit.prevent="submit" class="nl-form">
        ...
        <!-- Iznos -->
        <div class="nl-field">
          <label class="nl-label">Iznos (RSD) <span class="nl-req">*</span></label>
          <input
            v-model="form.iznos"
            type="number"
            min="1"
        ...
        <!-- Period -->
        <div class="nl-field">
          <label class="nl-label">Period (meseci) <span class="nl-req">*</span></label>
          <input
            v-model="form.period"
            type="number"
            min="1"
        ...
        <!-- Tip kamate -->
        <div class="nl-field">
          <label class="nl-label">Tip kamate <span class="nl-req">*</span></label>
          <div class="nl-radio-group">
            <label
        ...
        <!-- Račun za isplatu -->
        <div class="nl-field">
          <label class="nl-label">Račun za isplatu <span class="nl-req">*</span></label>
        ...
        <div v-if="formErrors.length > 0 && (form.vrsta || form.iznos || form.period)" class="nl-validation-list">
